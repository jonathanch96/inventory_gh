...
class UploadLogController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function destroy(Request $request, $id)
    {
    	...
    	/*custom delete*/
    	$item_ledger_data = ItemLedgerEntry::where('document_no',$data->document_no)->get();
    	foreach ($item_ledger_data as $key => $ild) {
    		$item_data = Item::find($ild->item_id);
    		if($item_data){
    			$temp_date = $ild->date;
    			$ild->forceDelete();
    			//recal quantity
    			$this->updateItemLedger($item_data->id,$temp_date);
